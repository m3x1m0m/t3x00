...
\begin{center}
	\smartdiagram[circular diagram:clockwise]{\ensuremath{t} gegeben, \ensuremath{M=n\cdot (t-t_P)} bestimmen, \ensuremath{E} mit Newton-Verfahren bestimmen, \ensuremath{x'} und \ensuremath{y'} bestimmen, ggf. \ensuremath{\theta} bestimmen, ggf. \ensuremath{r} bestimmen} 
\end{center}
...
\end{equation}  
Hierbei stellen \ensuremath{\mathbf{R_X}} und \ensuremath{\mathbf{R_Z}} folgende Drehmatrizen dar (vgl. S.89 in \cite{HandRaum}). 
\begin{equation}
\mathbf{R_X}(\alpha) = 
	\left(
		\begin{array}{ccc}
...
\newpar
Mit den Gleichungen \ref{equation1_kep_elements} und \ref{equation2_kep_elements} lässt sich nun die Antenne fast ausrichten und nachführen.    
