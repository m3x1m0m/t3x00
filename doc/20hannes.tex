...
\begin{table}[h]
	\caption[Betriebsmodi des \myemph{Antenna Control}-Bedienfelds]{Betriebsmodi des \myemph{Antenna Control}-Bedienfelds, Quelle: \cite{gpredictmanual}\vspace{-0.5em}}
...
\begin{table}[h]
	\caption[Betriebsmodi des \myemph{Radio Control}-Bedienfelds]{Betriebsmodi des \myemph{Radio Control}-Bedienfelds, Quelle: \cite{gpredictmanual}}
	\begin{tabularx}{\textwidth}{|l|l|X|}
		\hline
		\textbf{Track} 	    & \textbf{Engage}	&\textbf{Beschreibung}\\
		\hline
