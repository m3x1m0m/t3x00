...
\begin{itemize}
	...
	\item \textbf{Time resolution:}	
\item \textbf{Number of entries:} 
\item \textbf{Twilight threshold:} 
\end{itemize}

Reiter \myemph{Multiple Passes}, \myemph{Single Pass} und \myemph{Sky at a Glance} beschreiben!
